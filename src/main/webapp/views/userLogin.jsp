...
<div id="wrapper">
		...
		<div id="mainBg">
			<div id="mainPanel">
				...
				<div id="right">
					...
					<form name="loginForm" action="<%=path%>/user/userLogin" method="post">
					<!-- start of login form -->
					<div id="welcome">
					...
					<div id="user-name">
						...
						<span><input type="text" name="username" value="${user.username}" class="form-input" required="required"></span>
					</div>
					<div id="user-password">
						<span class="item">密&nbsp;&nbsp;&nbsp;码:</span>
						<span class="input"><input type="password" name="password" value="${user.password}" class="form-input" required="required"></span>
					</div>
					<div id="button-group">
					...
					<div>
						...
						<span style="color:red">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<strong>${loginErrorMessage}</strong> <!-- 显示表单验证的出错信息 -->
						</span> 
					</div>
					<!-- end of form -->
					</form>
	...
	<div id="footer">
		<div id="text">Copyright © 2015-2020 All Rights Reserved Powered By Liant</div>
	</div>
</div>
</body>
</html>